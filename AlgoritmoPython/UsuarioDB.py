...
def AddUsuario(id: int, nombre: string, apellidos: string, correo: string, telefono: string, fechaNac: string,
    ...
    record_to_insert = (id, nombre, apellidos, correo, telefono, fechaNac, dni, dirPost, dirFac, contra)
...
def UpdateUsuario(id: int, nombre: string, apellidos: string, correo: string, telefono: string, fechaNac: string,
    ...
    record_to_insert = (nombre, apellidos, correo, telefono, fechaNac, dni, dirPost, dirFac, contra, id)
...
def GetUsuario(id: string):
    ...
    DateTimeEncoder().encode(usuario)
    print(json.dumps(usuario, indent=4, cls=DateTimeEncoder))
